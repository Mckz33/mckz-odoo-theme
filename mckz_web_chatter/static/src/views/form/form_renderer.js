...
patch(FormRenderer.prototype, {
    setup() {
        ...
        this.chatterState = useState({
            width: browser.localStorage.getItem('mckz_web_chatter.width'),
        });
    ...
    onStartChatterResize(ev) {
        ...
        const resizePanel = (ev) => {
            ...
            browser.localStorage.setItem('mckz_web_chatter.width', newWidth);
    ...
    onDoubleClickChatterResize(ev) {
    	browser.localStorage.removeItem('mckz_web_chatter.width');
